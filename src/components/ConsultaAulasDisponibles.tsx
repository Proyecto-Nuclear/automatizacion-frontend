...
import { fetchAulasDisponibles, AulaDisponible, ConsultaAulasParams } from '../services/aulasApi';
        ...
        <div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                ...
                {aulas.length === 0 && !loading && (
                    <tr>
                        <td colSpan={4} style={{ textAlign: 'center' }}>No hay aulas disponibles para ese horario.</td>
                    </tr>
                )}
                </tbody>
            </table>
